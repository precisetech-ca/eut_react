...
const InnerForm = ({
    ...
    return (
        <Modal isOpen={PhysicalCountUIContext.showSupplierModal} toggle={PhysicalCountUIContext.toggleSupplierHandler} size="lg" centered>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <ModalFooter>
                    <Button color="danger" onClick={PhysicalCountUIContext.toggleSupplierHandler}>Cancel</Button>
