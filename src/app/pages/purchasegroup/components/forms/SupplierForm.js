...
const InnerForm = ({
    ...
    const { warehouseMockData} = PurchaseGroupUIContext;

    return (
        <Modal isOpen={PurchaseGroupUIContext.showSupplierModal} toggle={PurchaseGroupUIContext.toggleSupplierHandler} size="lg" centered>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <ModalFooter>
                    <Button color="danger" onClick={PurchaseGroupUIContext.toggleSupplierHandler}>Cancel</Button>
