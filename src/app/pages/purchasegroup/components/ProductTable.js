...
export function Table() {
  ...
  const customersUIProps = useMemo(() => {
    return {
      ...
      setIds: PurchaseGroupUIContext.setIds,
      queryParams: PurchaseGroupUIContext.queryParams,
      setQueryParams: PurchaseGroupUIContext.setQueryParams,
      openEditCustomerDialog: PurchaseGroupUIContext.openEditCustomerDialog,
      openDeleteCustomerDialog: PurchaseGroupUIContext.openDeleteCustomerDialog,
    };
